...
/**
 * Abstract base class for employment change declarations.
 *
 * Contains common fields shared by MA and MAD schemas:
 * - MA_v1 (ModificationDeclaration)
 * - MAD_v1 (BorrowedModificationDeclaration)
 *
 * @see xsd/MA_v1.xsd
 * @see xsd/MAD_v1.xsd
 */
abstract class Declaration extends Model
{
    ...
    /**
     * Get the date of the employment change.
     */
    public function getChangeDate(): ?string
    {
        return $this->get('f_date_metabolhs');
    }

    /**
     * @param DateTime|string $date Date in DD/MM/YYYY format
     */
    public function setChangeDate(DateTime|string $date): static
    {
        if ($date instanceof DateTime) {
            $date = $date->format('d/m/Y');
        }

        return $this->set('f_date_metabolhs', $date);
    }
    ...
    {
        return $this->get('f_topos_ergasias_comments');
    }

    /**
     * @param string $comment Location description (max 200 chars)
     */
    public function setWorkLocationComment(string $comment): static
    {
        return $this->set('f_topos_ergasias_comments', $comment);
    }
    ...
    /**
     * @param EmploymentStatus|string|int $status 0=Full-time, 1=Part-time, 2=Rotational (or use EmploymentStatus enum)
     */
    ...
    {
        return $this->get('f_mh_problepsimo_programma');
    }
    ...
    public function setUnpredictableSchedule(string|bool $value): static
    {
        ...
        return $this->set('f_mh_problepsimo_programma', $value);
    }
    ...
    /**
     * @param string $deadline Cancellation deadline description (max 1000 chars)
     */
    ...
    /**
     * Get general comments/remarks about the change.
     */
    ...
    // ==================== Borrow Details (Shared) ====================

    /**
     * Get the type of loan arrangement.
     */
    ...
    /**
     * @param LoanType|string|int $type 0=Genuine loan, 1=EPA (or use LoanType enum)
     */
    public function setLoanType(LoanType|string|int $type): static
    {
     ...
     */
    public function getLoanCompanyAfm(): ?string
    {
     ...
     * @param string $afm 9-digit AFM
     */
    public function setLoanCompanyAfm(string $afm): static
    {
     ...
     */
    public function getLoanCompanyName(): ?string
    {
     ...
     */
    public function setLoanCompanyName(string $name): static
    {
