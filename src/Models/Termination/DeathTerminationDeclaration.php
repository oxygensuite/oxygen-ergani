...
/**
 * Death termination declaration model for E5D_v1 schema.
 *
 * Used for reporting termination of employment due to employee death.
 *
 * @see xsd/E5D_v1.xsd
 *
 * @method static DeathTerminationDeclarationFactory factory(int $count = 1)
 */
