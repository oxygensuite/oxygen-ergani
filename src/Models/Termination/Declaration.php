...
/**
 * Abstract base class for termination/departure declarations.
 *
 * Contains common fields shared by all E5 termination schemas:
 * - E5N_v1 (VoluntaryResignationDeclaration)
 * - E5O_v1 (NotificationDeclaration)
 * - E5AO_v1 (ResignationAfterNotificationDeclaration)
 * - E5D_v1 (DeathTerminationDeclaration)
 * - E5E_v1 (CompensatedExitDeclaration)
 * - E5S_v1 (VoluntaryRetirementDeclaration)
 * - E5DS_v1 (MandatoryRetirementDeclaration)
 *
 * @see xsd/E5*_v1.xsd
 */
abstract class Declaration extends Model
{
    ...
    /**
     * @param EmploymentType|string|int $type 0=Indefinite, 1=Fixed-term, 2=Project
     */
    ...
    /**
     * Get the employee's departure/termination date.
     */
    public function getDepartureDate(): ?string
    {
        return $this->get('f_apoxwrisidate');
    }
