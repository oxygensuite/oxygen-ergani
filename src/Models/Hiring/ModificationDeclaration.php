...
/**
 * Hiring modification/transfer declaration model for E3M_v1 schema.
 *
 * Used for reporting employee transfers from another company to ERGANI.
 *
 * @see xsd/E3M_v1.xsd
 */
class ModificationDeclaration extends Declaration
{
    ...
    /**
     * Get the transfer date (when employee was transferred).
     */
    ...
    /**
     * Get the transfer company's TIN (AFM).
     */
    ...
    /**
     * @param string $afm 9-digit AFM of the transfer company
     */
    ...
    /**
     * Get the transfer company's name.
     */
