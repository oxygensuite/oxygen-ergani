...
/**
 * New hiring declaration model for E3N_v1 schema.
 *
 * Used for reporting new employee hirings to ERGANI.
 *
 * @see xsd/E3N_v1.xsd
 *
 * @method static NewDeclarationFactory factory(int $count = 1)
 */
class NewDeclaration extends Declaration
{
    ...
    protected array $expectedOrder = [
        ...
        // Employment Details (E3N specific)
        'f_proslipsidate',
        'f_proslipsitime',
        'f_apoxwrisitime',
        'f_week_hours',
