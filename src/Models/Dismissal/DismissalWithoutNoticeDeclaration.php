...
use OxygenSuite\OxygenErgani\Models\Dismissal\Concerns\HasTerminationNotification;
...
/**
 * Dismissal without notice declaration model for E6NXP_v1 schema.
 *
 * Used for employer-initiated immediate terminations (no notice period).
 * Includes compensation (severance) and collective dismissal tracking.
 *
 * @see xsd/E6NXP_v1.xsd
 *
 * @method static DismissalWithoutNoticeDeclarationFactory factory(int $count = 1)
 */
class DismissalWithoutNoticeDeclaration extends Declaration
{
    ...
    use HasTerminationNotification;
    use HasSalary;
    use HasCompensation;
    use HasFormFile;
    ...
    /**
     * Get the employee's dismissal date.
     */
