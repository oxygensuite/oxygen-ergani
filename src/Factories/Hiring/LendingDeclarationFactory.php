...
/**
 * Factory for generating fake LendingDeclaration (E3PD) models.
 *
 * @extends Factory<LendingDeclaration>
 */
class LendingDeclarationFactory extends Factory
{
    /**
     * Define the default attribute values for the LendingDeclaration model.
     *
    ...
    public function definition(): array
    {
        ...
        $lendingFrom = new DateTimeImmutable('today');
        $lendingTo = new DateTimeImmutable('+6 months');
        ...
        return [
            ...
            'f_borrow_date_from' => $lendingFrom->format('d/m/Y'),
            'f_borrow_date_to' => $lendingTo->format('d/m/Y'),
    ...
    /**
     * Configure the lending period.
     *
     * @return $this
     */
    public function lendingPeriod(string $from, string $to): static
    {
        return $this->state([
    ...
    /**
     * Configure the direct employer (lender).
     *
     * @return $this
     */
    public function fromDirectEmployer(string $afm, string $name): static
    {
        return $this->state([
