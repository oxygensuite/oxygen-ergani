...
/**
 * Factory for generating fake VoluntaryResignationDeclaration (E5N) models.
 *
 * @extends Factory<\OxygenSuite\OxygenErgani\Models\Termination\VoluntaryResignationDeclaration>
 */
class VoluntaryResignationDeclarationFactory extends Factory
{
    use HasBaseDefinition;

    /**
     * Define the default attribute values for the VoluntaryResignationDeclaration model.
     *
