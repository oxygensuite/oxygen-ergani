...
/**
 * Factory for creating ConstructionWork instances with fake data.
 *
 * @extends Factory<\OxygenSuite\OxygenErgani\Models\Construction\ConstructionWork>
 */
class ConstructionWorkFactory extends Factory
{
    /**
     * Define the default attribute values for ConstructionWork.
     *
    ...
    public function definition(): array
    {
        ...
        return [
            ...
            'f_rel_protocol' => '',
            'f_rel_date' => '',
            'f_date_from' => $fake->greekDate('-1 week', 'now'),
            'f_date_to' => $fake->greekDate('now', '+1 week'),
            'f_phase' => '',
            ...
            'f_comments' => '',
            'Ergazomenoi' => fn() => ['AmoeErgazomenosDate' => [ConstructionEmployeeFactory::new()->make()]],
        ];
    }
    ...
    {
        return $this->state([
            'Ergazomenoi' => fn() => ['AmoeErgazomenosDate' => ConstructionEmployeeFactory::new()->count($count)->make()],
        ]);
    }
     ...
     *
     * @param array<int, \OxygenSuite\OxygenErgani\Models\Construction\ConstructionEmployee> $employees
     */
